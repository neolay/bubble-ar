...
/* harmony export */   "THREE_MESH_BVH": () => (/* reexport module object */ three_mesh_bvh__WEBPACK_IMPORTED_MODULE_25__),
/* harmony export */   "ThreeRenderManager": () => (/* binding */ ThreeRenderManager)
/* harmony export */ });
/* harmony import */ var three__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! three */ "./node_modules/three/build/three.module.js");
/* harmony import */ var three_mesh_bvh__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! three-mesh-bvh */ "./node_modules/three-mesh-bvh/src/index.js");
...
/* harmony import */ var three_examples_jsm_webxr_ARButton_js__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! three/examples/jsm/webxr/ARButton.js */ "./node_modules/three/examples/jsm/webxr/ARButton.js");
/* harmony import */ var three_examples_jsm_webxr_XRControllerModelFactory_js__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! three/examples/jsm//webxr/XRControllerModelFactory.js */ "./node_modules/three/examples/jsm/webxr/XRControllerModelFactory.js");
/* harmony import */ var _croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! @croquet/worldcore-kernel */ "./node_modules/@croquet/worldcore-kernel/index.js");
...
//-- ThreeVisible  -------------------------------------------------------------------------
//------------------------------------------------------------------------------------------
const PM_ThreeVisible = superclass => class extends (0,_croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_23__.PM_Visible)(superclass) {
...
const PM_ThreeCamera = superclass => class extends (0,_croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_23__.PM_Camera)(superclass) {
    constructor(...args) {
        super(...args);
...
class XRController {
    constructor(manager) {
        ...
        this.controllerModelFactory = new three_examples_jsm_webxr_XRControllerModelFactory_js__WEBPACK_IMPORTED_MODULE_22__.XRControllerModelFactory();
...
class ThreeRenderManager extends _croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_23__.RenderManager {
    ...
    setupRenderer(options) {
        ...
        this.hasXR().then((xr) => {
            if (xr) {
                this.arButton = three_examples_jsm_webxr_ARButton_js__WEBPACK_IMPORTED_MODULE_21__.ARButton.createButton(this.renderer);
...
const THREE = {
    ...three__WEBPACK_IMPORTED_MODULE_24__, Pass: three_examples_jsm_postprocessing_Pass_js__WEBPACK_IMPORTED_MODULE_2__.Pass, UnrealBloomPass: three_examples_jsm_postprocessing_UnrealBloomPass_js__WEBPACK_IMPORTED_MODULE_18__.UnrealBloomPass, CopyShader: three_examples_jsm_shaders_CopyShader_js__WEBPACK_IMPORTED_MODULE_3__.CopyShader, CSMFrustum: three_examples_jsm_csm_CSMFrustum_js__WEBPACK_IMPORTED_MODULE_4__.CSMFrustum, CSMShader: three_examples_jsm_csm_CSMShader_js__WEBPACK_IMPORTED_MODULE_5__.CSMShader, CSM: three_examples_jsm_csm_CSM_js__WEBPACK_IMPORTED_MODULE_6__.CSM,
...
class MyViewRoot extends _croquet_worldcore_kernel__WEBPACK_IMPORTED_MODULE_0__.ViewRoot {
    static viewServices() {
        const services = [
            ...
            {service: _ThreeRender_js__WEBPACK_IMPORTED_MODULE_1__.ThreeRenderManager, options:{useBVH: true, antialias: AA, alpha: true}},
...
function startSettingsMenu(useEnter, noAvatarFlag, r) {
...
function startShareMenu(avatar, noAvatarFlag) {
    noAvatar = noAvatarFlag;
    (0,_worldMenu_js__WEBPACK_IMPORTED_MODULE_0__.closeAllDialogs)();
